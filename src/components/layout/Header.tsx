...
const Header = () => {
  ...
  return (
    <>
            ...
            <ul className="flex flex-row gap-2 py-2 text-[14px] font-bold text-white">
              <li className="mr-4 hover:cursor-pointer">
                <HoverDropdown label="Movies">
                  ...
                  <DropdownMenu.DropdownMenuItem className="py-2 pr-12 pl-4 outline-none hover:bg-gray-200">
                    Now Playing
                  </DropdownMenu.DropdownMenuItem>
                  <DropdownMenu.DropdownMenuItem className="py-2 pr-12 pl-4 outline-none hover:bg-gray-200">
                    Upcoming
                  </DropdownMenu.DropdownMenuItem>
                  <DropdownMenu.DropdownMenuItem className="mb-1.5 py-2 pr-12 pl-4 outline-none hover:bg-gray-200">
                    Top Rated
                  </DropdownMenu.DropdownMenuItem>
                </HoverDropdown>
              </li>
              <li className="mr-4 hover:cursor-pointer">
                <HoverDropdown label="TV Shows">
                  <DropdownMenu.DropdownMenuItem className="mt-1.5 py-2 pr-12 pl-4 outline-none hover:bg-gray-200">
                    Popular
                  </DropdownMenu.DropdownMenuItem>
                  <DropdownMenu.DropdownMenuItem className="py-2 pr-12 pl-4 outline-none hover:bg-gray-200">
                    Airing Today
      ...
      <div className="sticky top-0 z-10 h-11 w-full bg-white shadow-2xs">
